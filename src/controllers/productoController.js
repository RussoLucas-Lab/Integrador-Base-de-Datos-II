import { Producto } from '../models/productoModel.js' // Modelo Mongoose (ajustar ruta si es necesario)
...
export const obtenerProducto = async (req, res) => {
    try {
        ...
        return res.status(500).json({ error: 'Error al obtener producto', details: err.message });
    }
}
